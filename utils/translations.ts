...
export const translations: Record<Language, any> = {
  ...
  ar: {
    heroSubtitle: "فك رموز السياق. افهم النبرة. رد بثقة.",
    getStarted: "ابدأ الآن",
    decodeTitle: "فك تشفير النية",
    decodeDesc: "الصق النص المحير أو قم بتحميل لقطة شاشة.",
    analyzingTitle: "جاري التحليل...",
    analyzingDesc: "قراءة ما بين السطور",

    letMakeSense: "دعونا نفهم هذا معًا.",
    uploadFile: "تحميل ملف",
    uploadDesc: "صورة، صوت أو فيديو",
    pasteText: "لصق نص الدردشة",
    pasteDesc: "أو استخدم الميكروفون",
    plainMode: "وضع اللغة البسيطة",
    previewLabel: "معاينة",
    previewDesc: "سيتم تجريد التحليل من المصطلحات والعبارات المعقدة.",
    analyzeText: "تحليل النص",
    analyzeAudioText: "تحليل الصوت والنص",
    ...
    footerSocialContext: "السياق الاجتماعي",
    footerEmotionalSafety: "السلامة العاطفية",
    footerClarity: "الوضوح والتركيز",
    footerConflict: "حل النزاعات",
    footerCompany: "الشركة",
    footerCareers: "وظائف",
    footerBlog: "المدونة",
    footerInfluencer: "برنامج المؤثرين",
    footerLegal: "قانوني",
    footerTerms: "شروط الخدمة",
    footerPrivacy: "سياسة الخصوصية",
    footerRefund: "سياسة الاسترجاع",
    footerDisclaimer: "إخلاء المسؤولية",
    footerRights: "حقوق النشر © 2025 Neuro-Sense, Inc. جميع الحقوق محفوظة.",

    // Existing
    subtitle: "فك رموز السياق السحري",
    sourceTitle: "المصدر",
    sourceDesc: "الصق النص المحير أو قم بتحميل لقطة شاشة. دعونا نفهم هذا معًا.",
    extensionTitle: "احصل على إضافة كروم",
    extensionDesc: "فك تشفير واتساب وماسنجر تلقائيًا في متصفحك.",
    clarityTitle: "الوضوح",
    unlocking: "فتح المعنى...",
    readyTitle: "جاهز للفك؟",
    readyDesc: "سيظهر التفسير هنا، مكتوبًا بوضوح.",
    back: "رجوع",
    error: "لم نتمكن من فك تشفير تلك الرسالة الآن. يرجى المحاولة مرة أخرى.",
    inputPlaceholder: "عزيزي المذكرات، اليوم قالوا...",
    voicePlaceholder: "أستمع...",
    attach: "إرفاق لقطة شاشة",
    attachAudio: "إرفاق صوت",
    deepContext: "تفعيل السياق العميق",
    analyze: "تحليل الرسالة",
    consulting: "استشارة...",
    vibeCheck: "فحص الحالة المزاجية",
    translation: "الترجمة الحرفية",
    subtext: "النص الضمني العاطفي",
    vocalToneLabel: "تحليل نبرة الصوت",
    suggestedReply: "الرد المقترح",
    certainty: "اليقين",
    copy: "نسخ",
    copied: "تم النسخ",
    panicBtn: "مساعدة، أنا غارق",
    panicTitle: "تنفس بعمق. أنت بخير.",
    panicDesc: "إذا كنت تشعر بالإرهاق، فلا بأس من إيقاف المحادثة مؤقتًا. استخدم هذا النص لكسب الوقت.",
    panicScript: "لقد تلقيت رسالتك وأريد أن أمنحها الاهتمام الذي تستحقه. أحتاج لبعض الوقت لمعالجتها، لكنني سأرد عليك في أقرب وقت ممكن. شكرًا لصبرك.",
    voiceAccent: "اللهجة / الأصل",
    close: "إغلاق",
    stop: "توقف",
    voiceDictation: "إملاء الرسالة",
    removeImage: "إزالة الصورة",
    removeAudio: "إزالة الصوت",
    saveToMemory: "حفظ في الذاكرة",
    savedToMemory: "تم الحفظ!",
    memoriesTitle: "الذاكرة طويلة المدى",
    noMemories: "لا توجد محادثات محفوظة بعد.",
    viewMemories: "الذكريات",
    memorySaved: "تم حفظ الذكرى.",
    delete: "حذف",

    // Concern
    concernTitle: "مطلوب اهتمام لطيف",
    careAdviceTitle: "النهج الموصى به",

    // Crisis
    crisisTitle: "وضع دعم الأزمات",
    crisisDesc: "لقد اكتشفنا علامات ضائقة شديدة. أنت لست وحدك.",
    disclaimer: "إخلاء المسؤولية: Neuro-Sense هي أداة ذكاء اصطناعي وليست بديلاً عن الرعاية الصحية النفسية المهنية. إذا كنت أنت أو أي شخص آخر في خطر، يرجى الاتصال بخدمات الطوارئ على الفور."
  }
};
